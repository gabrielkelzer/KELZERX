...
${COR1}               /////              ////   KELZER-X
		...
		${COR2}[ ${COR4}01 ${COR2}]${COR2} CRIAR UMA PAYLOAD COM O METASPLOIT
		${COR2}[ ${COR4}02 ${COR2}]${COR2} INFECTAR APLICATIVOS ORIGINAIS 
		${COR2}[ ${COR4}03 ${COR2}]${COR2} INSTALAR O METASPLOIT NO TERMUX ${COR0}-> ${COR3}300MB${COR0}
		${COR2}[ ${COR4}04 ${COR2}]${COR2} INSTALAR O APKTOOL    ${COR0}-> ${COR3}5MB${COR0}
		${COR2}[ ${COR4}05 ${COR2}]${COR2} SAIR DO KELZERX
		${COR2}[ ${COR4}06 ${COR2}]${COR2} SOBRE O SCRIPT
